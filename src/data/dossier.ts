...
export const charges: Charge[] = [
  ...
  },
  {
    ...
    testimony: [
      'Product marketing, growth marketing, content marketing, product management, and enough front-end to be dangerous. T-shaped is a flattering way to describe what is really just a refusal to hand work off when it would be faster to do it.',
    ],
  },
];
